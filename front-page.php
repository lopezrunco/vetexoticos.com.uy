...
<div class="hero">
	<div class="container">
		<div class="content-wrapper">
			<h5 class="subtitle">Encuentra los mejores suplementos</h5>
			<h2 class=title"">Sabemos que los animales son parte de tu familia, por eso, te ayudamos a cuidarlos.</h2>
