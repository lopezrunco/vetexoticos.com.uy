			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 mb-5">
						<div class="content-wrapper">
							<div class="image-wrapper">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/client-1.jpg" alt="Foto de cliente">
							</div>
							<p class="testimonial">
					...
					<div class="col-lg-4 mb-5">
						<div class="content-wrapper">
							<div class="image-wrapper">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/client-2.jpg" alt="Foto de cliente">
							</div>
							<p class="testimonial">
					...
					<div class="col-lg-4 mb-5">
						<div class="content-wrapper">
							<div class="image-wrapper">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/client-3.jpg" alt="Foto de cliente">
							</div>
							<p class="testimonial">
